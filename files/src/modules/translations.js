...
let translations = {
	...
	"Polski": {
		...
		"Tree": "Drzewo",
			...
			"Delete children": "Usuń potomne",
			"Delete siblings": "Usuń warianty",
			"Delete ALL other lines": "Usuń WSZYSTKIE inne linie",
			"Show PGN games list": "Pokaż listę partii PGN",
			"Escape": "Wyjście",
		"Analysis": "Analiza",
			"Go": "Start",
			"Go and lock engine": "Start i zablokuj silnik",
			"Return to locked position": "Powrót do zablokowanej pozycji",
			"Halt": "Stop",
			"Auto-evaluate line": "Auto-analiza linii",
			"Auto-evaluate line, backwards": "Auto-analiza linii, wstecz",
			"Show focus (searchmoves) buttons": "Pokaż przyciski zawężania (searchmoves)",
			"Clear focus": "Wyczyść zawężanie",
			"Invert focus": "Odwróć zawężanie",
			"Winrate POV": "Szansa wygranej POV",
				"Current": "Bieżący",
				"White": "Białe",
				"Black": "Czarne",
			"Centipawn POV": "Setne piona POV",
			"Win / draw / loss POV": "Wygrana / remis / przegrana POV",
		...
		"Display": "Widok",
			...
			"Arrows": "Strzałki",
			"Piece-click spotlight": "Podświetlanie ruchów figury",
			"Always show actual move (if known)": "Zawsze pokazuj wykonany ruch (jeśli znany)",
			"...with unique colour": "...unikalnym kolorem",
			...
			"Arrowhead type": "Typ strzałek",
				...
				"Moves Left Head": "Pozostało ruchów",
			...
			"Infobox stats": "Statystyki infoboxu",
				...
				"Linebreak before stats": "Nowa linia przed statystykami",
		...
		"Engine": "Silnik",
			...
			"Weights": "Wagi",
				"Lc0 WeightsFile...": "Plik wag Lc0...",
				"Stockfish EvalFile...": "Plik oceny Stockfish...",
		...
		"Dev": "Rozwój",
			...
			"Toggle Debug CSS": "Przełącz CSS debugowania",
			"Permanently enable save": "Trwale włącz zapis",
			"Show config.json": "Pokaż config.json",
			"Show engines.json": "Pokaż engines.json",
			"Reload engines.json (and restart engine)": "Przeładuj engines.json (i zrestartuj silnik)",
			...
			"Hacks and kludges": "Modyfikacje i obejścia",
				...
				"Never hide focus buttons": "Nigdy nie ukrywaj przycisków zawężania",
			...
			"Logging": "Logowanie",
				...
				"...including useless lines": "...włącznie z bezużytecznymi",
		"Language": "Język",
	...
	"עברית": {
		...
		"EV": "ערך צפוי",
		"Centipawns": "מאיות רגל",
		"N (%)": "צמתים (%)",
		"N (absolute)": "צמתים (מוחלט)",
		"...out of total": "...מתוך סך הכל",
		"Depth (A/B only)": "עומק (A/B בלבד)",
		"Cut": "גזור",
		"Copy": "העתק",
		"Paste": "הדבק",
		"Quit": "יציאה",
		...
		"Next sibling": "אח הבא",
		"Return to main line": "חזור לקו ראשי",
		...
		"Delete ALL other lines": "מחק כל קווים אחרים",
		"Show PGN games list": "הצג רשימת משחקי PGN",
		"Escape": "יציאה",
		"Analysis": "ניתוח",
		"Go": "התחל",
		"Go and lock engine": "התחל ונעל מנוע",
		...
		"Winrate": "סיכויי ניצחון",
		"Node %": "אחוז צמתים",
		"Policy": "מדיניות",
		"MultiPV rank": "דרוג MultiPV",
		"Moves Left Head": "מהלכים נותרים",
		...
		"Book frequency arrows": "חצי תדירות ספר",
		"Lichess frequency arrows": "חצי תדירות Lichess",
		"Sizes": "גדלים",
		"Infobox font": "גופן תיבת מידע",
		...
		"Engine": "מנוע",
		"Choose engine...": "בחר מנוע...",
		"Choose known engine...": "בחר מנוע מוכר...",
		"Weights": "משקולות",
		"Lc0 WeightsFile...": "קובץ משקולות Lc0...",
		"Stockfish EvalFile...": "קובץ הערכה Stockfish...",
		"Set to <auto>": "הגדר ל<auto>",
		"Backend": "Backend",
		...
		"Threads": "חוטים",
		"Warning about threads": "אזהרה לגבי חוטים",
		"Hash": "זיכרון מטמון",
		"I want other hash options!": "אני רוצה אפשרויות מטמון אחרות!",
		"MultiPV": "MultiPV",
		"Contempt Mode": "מצב בוז",
		...
		"Restart engine": "הפעל מנוע מחדש",
		"Soft engine reset": "איפוס מנוע רך",
		"Play": "משחק",
		"Play this colour": "שחק בצבע זה",
		"Start self-play": "התחל משחק עצמי",
		"Use Polyglot book...": "השתמש בספר Polyglot...",
		"Use PGN book...": "השתמש בספר PGN...",
		"Unload book / abort load": "בטל טעינת ספר",
		"Book depth limit": "מגבלת עומק ספר",
		"Temperature": "טמפרטורה",
		"Temp Decay Moves": "דעיכת טמפרטורה במהלכים",
		"Infinite": "אינסוף",
		"About play modes": "אודות מצבי משחק",
		"Dev": "פיתוח",
		"Toggle Developer Tools": "הפעל/כבה כלי פיתוח",
		"Toggle Debug CSS": "הפעל/כבה CSS לניפוי",
		...
		"Spin rate": "קצב ריענון",
		"Frenetic": "קדחתני",
		"Fast": "מהיר",
		"Normal": "רגיל",
		"Relaxed": "רגוע",
		"Lazy": "עצלן",
		"Show engine state": "הצג מצב מנוע",
		"List sent options": "הצג אפשרויות שנשלחו",
		"Show error log": "הצג יומן שגיאות",
		"Hacks and kludges": "תיקונים ופתרונות",
		...
		"Fire GC": "הפעל GC",
		"Logging": "רישום",
		"Use logfile...": "השתמש בקובץ יומן...",
		"Disable logging": "בטל רישום",
		"Clear log when opening": "נקה יומן בפתיחה",
		"Use unique logfile each time": "השתמש בקובץ יומן ייחודי בכל פעם",
		...
		"RESTART_REQUIRED": "יש להפעיל מחדש את הממשק"
	},
