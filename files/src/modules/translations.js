...
module.exports = {
	...
	"Українська": {
		...
		"Show config.json": "Показати config.json",
		"Show engines.json": "Показати engines.json",
		"Reload engines.json (and restart engine)": "Перезавантажити engines.json",
	...
	"हिंदी": {
		...
		"Show config.json": "config.json दिखाएं",
		"Show engines.json": "engines.json दिखाएं",
		"Reload engines.json (and restart engine)": "engines.json पुनः लोड करें (और इंजन पुनः प्रारंभ करें)",
